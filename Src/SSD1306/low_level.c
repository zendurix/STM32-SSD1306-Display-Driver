...
#define SSD1306_SLAVE_ADDR 0b0111100U
...
void ssd1306_init_transfer(uint8_t bytes_num) {
	...
	// target address (control mode) - use address specified by ssd1306
	// shift address bit by 1 left - according to I2C doc, address is in bits [7:1]
	I2C1->CR2 &= ~(I2C_CR2_SADD);
	I2C1->CR2 |= (SSD1306_SLAVE_ADDR << I2C_CR2_SADD_Pos << 1);
